...
describe('subscription', () => {
  ...
  beforeAll(async () => {
    ...
    await subscriptionRepository.insert(subscriptionSeeder.collectionSource);
  ...
  test('/REST:POST webhook/subscription/find/{id} - Got 404 Not Found', () => {
    return request(app.getHttpServer())
      .post('/webhook/subscription/find/8b6bb939-9fea-544d-a514-d5b5ef160201')
      .set('Accept', 'application/json')
      .expect(404);
  });
  ...
  test('/REST:POST webhook/subscription/find/{id}', () => {
    return request(app.getHttpServer())
      .post('/webhook/subscription/find/5b19d6ac-4081-573b-96b3-56964d5326a8')
      .set('Accept', 'application/json')
      .expect(200)
      .then((res) => {
        expect(res.body).toHaveProperty(
    ...
    return request(app.getHttpServer())
      ...
      .then((res) => {
        for (const [
          ...
          expect(subscriptionSeeder.collectionResponse[index]).toEqual(
            expect.objectContaining(
  ...
  test('/GraphQL webhookFindSubscriptionById', () => {
    return request(app.getHttpServer())
      ...
      .expect(200)
      .then((res) => {
        expect(res.body.data.webhookFindSubscriptionById.id).toStrictEqual(
          '5b19d6ac-4081-573b-96b3-56964d5326a8',
        );
      });
  });
  ...
  test('/GraphQL webhookUpdateSubscriptionById', () => {
    return request(app.getHttpServer())
      ...
      .expect(200)
      .then((res) => {
        expect(res.body.data.webhookUpdateSubscriptionById.id).toStrictEqual(
          '5b19d6ac-4081-573b-96b3-56964d5326a8',
        );
      });
  });
  ...
  test('/GraphQL webhookUpdateSubscriptions', () => {
    return request(app.getHttpServer())
      ...
      .expect(200)
      .then((res) => {
        expect(res.body.data.webhookUpdateSubscriptions[0].id).toStrictEqual(
          '5b19d6ac-4081-573b-96b3-56964d5326a8',
        );
      });
  });
  ...
  test('/GraphQL webhookDeleteSubscriptionById', () => {
    return request(app.getHttpServer())
      ...
      .expect(200)
      .then((res) => {
        expect(res.body.data.webhookDeleteSubscriptionById.id).toStrictEqual(
          '5b19d6ac-4081-573b-96b3-56964d5326a8',
        );
      });
  });
