...
describe('field', () => {
  ...
  beforeAll(async () => {
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [SearchEngineMockFieldSeeder],
    })
    ...
    fieldRepository = module.get<SearchEngineIFieldRepository>(
      SearchEngineIFieldRepository,
    );
    fieldSeeder = module.get<SearchEngineMockFieldSeeder>(
      SearchEngineMockFieldSeeder,
    );
    ...
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for SearchEngineFieldId must be defined, can not be null',
        );
      });
  });
  ...
  test('/REST:POST search-engine/field/create - Got 400 Conflict, FieldCollectionId property can not to be null', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for SearchEngineFieldCollectionId must be defined, can not be null',
        );
      });
  });
  ...
  test('/REST:POST search-engine/field/create - Got 400 Conflict, FieldName property can not to be null', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for SearchEngineFieldName must be defined, can not be null',
        );
      });
  });
  ...
  test('/REST:POST search-engine/field/create - Got 400 Conflict, FieldType property can not to be null', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for SearchEngineFieldType must be defined, can not be null',
        );
      });
  });
  ...
  test('/REST:POST search-engine/field/create - Got 400 Conflict, FieldIsNullable property can not to be null', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for SearchEngineFieldIsNullable must be defined, can not be null',
        );
      });
  });
  ...
  test('/REST:POST search-engine/field/create - Got 400 Conflict, FieldId property can not to be undefined', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for SearchEngineFieldId must be defined, can not be undefined',
        );
      });
  });
  ...
  test('/REST:POST search-engine/field/create - Got 400 Conflict, FieldCollectionId property can not to be undefined', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for SearchEngineFieldCollectionId must be defined, can not be undefined',
        );
      });
  });
  ...
  test('/REST:POST search-engine/field/create - Got 400 Conflict, FieldName property can not to be undefined', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for SearchEngineFieldName must be defined, can not be undefined',
        );
      });
  });
  ...
  test('/REST:POST search-engine/field/create - Got 400 Conflict, FieldType property can not to be undefined', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for SearchEngineFieldType must be defined, can not be undefined',
        );
      });
  });
  ...
  test('/REST:POST search-engine/field/create - Got 400 Conflict, FieldIsNullable property can not to be undefined', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for SearchEngineFieldIsNullable must be defined, can not be undefined',
        );
      });
  });
  ...
  test('/REST:POST search-engine/field/create - Got 400 Conflict, FieldId is not allowed, must be a length of 36', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for SearchEngineFieldId is not allowed, must be a length of 36',
        );
      });
  });
  ...
  test('/REST:POST search-engine/field/create - Got 400 Conflict, FieldCollectionId is not allowed, must be a length of 36', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for SearchEngineFieldCollectionId is not allowed, must be a length of 36',
        );
      });
  });
  ...
  test('/REST:POST search-engine/field/create - Got 400 Conflict, FieldName is too large, has a maximum length of 255', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for SearchEngineFieldName is too large, has a maximum length of 255',
        );
      });
  });
  ...
  test('/REST:POST search-engine/field/create - Got 400 Conflict, FieldType is too large, has a maximum length of 63', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for SearchEngineFieldType is too large, has a maximum length of 63',
        );
      });
  });
  ...
  test('/REST:POST search-engine/field/create - Got 400 Conflict, FieldIsNullable has to be a boolean value', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for SearchEngineFieldIsNullable has to be a boolean value',
        );
      });
  });
    ...
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body).toEqual({
          ...
          rows: fieldSeeder.collectionResponse
            .map((item) =>
  ...
  test('/REST:POST search-engine/fields/get', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body).toEqual(
          fieldSeeder.collectionResponse.map((item) =>
            expect.objectContaining(
              _.omit(item, ['createdAt', 'updatedAt', 'deletedAt']),
            ),
          ),
  ...
  test('/REST:DELETE search-engine/field/delete/{id} - Got 404 Not Found', () => {
    return request(app.getHttpServer())
      .delete(
        '/search-engine/field/delete/6f96fed0-dbd1-5f04-9514-370a50d0c27c',
      )
      .set('Accept', 'application/json')
      .expect(404);
  });
  ...
  test('/REST:DELETE search-engine/field/delete/{id}', () => {
    return request(app.getHttpServer())
      .delete(
        '/search-engine/field/delete/5b19d6ac-4081-573b-96b3-56964d5326a8',
      )
      .set('Accept', 'application/json')
      .expect(200);
  });
    ...
    return request(app.getHttpServer())
      ...
      .then((res) => {
        for (const [
          index,
          value,
        ] of res.body.data.searchEngineGetFields.entries()) {
          expect(fieldSeeder.collectionResponse[index]).toEqual(
            expect.objectContaining(
  ...
  test('/GraphQL searchEngineCreateField', () => {
    return request(app.getHttpServer())
      ...
      .expect(200)
      .then((res) => {
        expect(res.body.data.searchEngineCreateField).toHaveProperty(
          'id',
          '5b19d6ac-4081-573b-96b3-56964d5326a8',
        );
      });
  ...
  test('/GraphQL searchEngineFindField', () => {
    return request(app.getHttpServer())
      ...
      .expect(200)
      .then((res) => {
        expect(res.body.data.searchEngineFindField.id).toStrictEqual(
          '5b19d6ac-4081-573b-96b3-56964d5326a8',
        );
      });
  });
  ...
  test('/GraphQL searchEngineFindFieldById', () => {
    return request(app.getHttpServer())
      ...
      .expect(200)
      .then((res) => {
        expect(res.body.data.searchEngineFindFieldById.id).toStrictEqual(
          '5b19d6ac-4081-573b-96b3-56964d5326a8',
        );
      });
  });
  ...
  test('/GraphQL searchEngineUpdateFieldById', () => {
    return request(app.getHttpServer())
      ...
      .expect(200)
      .then((res) => {
        expect(res.body.data.searchEngineUpdateFieldById.id).toStrictEqual(
          '5b19d6ac-4081-573b-96b3-56964d5326a8',
        );
      });
  });
  ...
  test('/GraphQL searchEngineUpdateFields', () => {
    return request(app.getHttpServer())
      ...
      .expect(200)
      .then((res) => {
        expect(res.body.data.searchEngineUpdateFields[0].id).toStrictEqual(
          '5b19d6ac-4081-573b-96b3-56964d5326a8',
        );
      });
  });
  ...
  test('/GraphQL searchEngineDeleteFieldById', () => {
    return request(app.getHttpServer())
      ...
      .expect(200)
      .then((res) => {
        expect(res.body.data.searchEngineDeleteFieldById.id).toStrictEqual(
          '5b19d6ac-4081-573b-96b3-56964d5326a8',
        );
      });
  });
