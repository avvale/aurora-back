...
describe('collection', () => {
  ...
  beforeAll(async () => {
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [SearchEngineMockCollectionSeeder],
    })
    ...
    collectionRepository = module.get<SearchEngineICollectionRepository>(
      SearchEngineICollectionRepository,
    );
    collectionSeeder = module.get<SearchEngineMockCollectionSeeder>(
      SearchEngineMockCollectionSeeder,
    );
    ...
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for SearchEngineCollectionId must be defined, can not be null',
        );
      });
  });
  ...
  test('/REST:POST search-engine/collection/create - Got 400 Conflict, CollectionName property can not to be null', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for SearchEngineCollectionName must be defined, can not be null',
        );
      });
  });
  ...
  test('/REST:POST search-engine/collection/create - Got 400 Conflict, CollectionStatus property can not to be null', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for SearchEngineCollectionStatus must be defined, can not be null',
        );
      });
  });
  ...
  test('/REST:POST search-engine/collection/create - Got 400 Conflict, CollectionIsEnableNestedFields property can not to be null', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for SearchEngineCollectionIsEnableNestedFields must be defined, can not be null',
        );
      });
  });
  ...
  test('/REST:POST search-engine/collection/create - Got 400 Conflict, CollectionId property can not to be undefined', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for SearchEngineCollectionId must be defined, can not be undefined',
        );
      });
  });
  ...
  test('/REST:POST search-engine/collection/create - Got 400 Conflict, CollectionName property can not to be undefined', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for SearchEngineCollectionName must be defined, can not be undefined',
        );
      });
  });
  ...
  test('/REST:POST search-engine/collection/create - Got 400 Conflict, CollectionStatus property can not to be undefined', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for SearchEngineCollectionStatus must be defined, can not be undefined',
        );
      });
  });
  ...
  test('/REST:POST search-engine/collection/create - Got 400 Conflict, CollectionIsEnableNestedFields property can not to be undefined', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for SearchEngineCollectionIsEnableNestedFields must be defined, can not be undefined',
        );
      });
  });
  ...
  test('/REST:POST search-engine/collection/create - Got 400 Conflict, CollectionId is not allowed, must be a length of 36', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for SearchEngineCollectionId is not allowed, must be a length of 36',
        );
      });
  });
  ...
  test('/REST:POST search-engine/collection/create - Got 400 Conflict, CollectionName is too large, has a maximum length of 255', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for SearchEngineCollectionName is too large, has a maximum length of 255',
        );
      });
  });
  ...
  test('/REST:POST search-engine/collection/create - Got 400 Conflict, CollectionAlias is too large, has a maximum length of 255', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for SearchEngineCollectionAlias is too large, has a maximum length of 255',
        );
      });
  });
  ...
  test('/REST:POST search-engine/collection/create - Got 400 Conflict, CollectionDefaultSortingField is too large, has a maximum length of 255', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for SearchEngineCollectionDefaultSortingField is too large, has a maximum length of 255',
        );
      });
  });
  ...
  test('/REST:POST search-engine/collection/create - Got 400 Conflict, CollectionDocumentsNumber has to be a integer value', () => {
    return request(app.getHttpServer())
      ...
      .send({
        ...mockData[0],
        documentsNumber: 100.1,
      })
      .expect(400)
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for SearchEngineCollectionDocumentsNumber has to be a integer value',
        );
      });
  });
  test('/REST:POST search-engine/collection/create - Got 400 Conflict, CollectionTimestampCreatedAt has to be a integer value', () => {
    return request(app.getHttpServer())
      ...
      .send({
        ...mockData[0],
        timestampCreatedAt: 100.1,
      })
      .expect(400)
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for SearchEngineCollectionTimestampCreatedAt has to be a integer value',
        );
      });
  });
  test('/REST:POST search-engine/collection/create - Got 400 Conflict, CollectionIsEnableNestedFields has to be a boolean value', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for SearchEngineCollectionIsEnableNestedFields has to be a boolean value',
        );
      });
  });
  test('/REST:POST search-engine/collection/create - Got 400 Conflict, CollectionStatus has to be a enum option of CONSOLIDATED, INDEXING', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for SearchEngineCollectionStatus has to be any of this options: CONSOLIDATED, INDEXING',
        );
      });
  });
    ...
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body).toEqual({
          ...
          rows: collectionSeeder.collectionResponse
            .map((item) =>
  ...
  test('/REST:POST search-engine/collections/get', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body).toEqual(
          collectionSeeder.collectionResponse.map((item) =>
            expect.objectContaining(
              _.omit(item, ['createdAt', 'updatedAt', 'deletedAt']),
            ),
          ),
  ...
  test('/REST:POST search-engine/collection/find/{id} - Got 404 Not Found', () => {
    return request(app.getHttpServer())
      .post(
        '/search-engine/collection/find/4954a302-a390-5841-a38d-99735d3ba730',
      )
      .set('Accept', 'application/json')
      .expect(404);
  });
  ...
  test('/REST:POST search-engine/collection/find/{id}', () => {
    return request(app.getHttpServer())
      .post(
        '/search-engine/collection/find/5b19d6ac-4081-573b-96b3-56964d5326a8',
      )
      .set('Accept', 'application/json')
      .expect(200)
      .then((res) => {
  ...
  test('/REST:DELETE search-engine/collection/delete/{id} - Got 404 Not Found', () => {
    return request(app.getHttpServer())
      .delete(
        '/search-engine/collection/delete/cc52bff5-612c-5d47-acca-4791836441de',
      )
      .set('Accept', 'application/json')
      .expect(404);
  });
  ...
  test('/REST:DELETE search-engine/collection/delete/{id}', () => {
    return request(app.getHttpServer())
      .delete(
        '/search-engine/collection/delete/5b19d6ac-4081-573b-96b3-56964d5326a8',
      )
      .set('Accept', 'application/json')
      .expect(200);
  });
    ...
    return request(app.getHttpServer())
      ...
      .then((res) => {
        for (const [
          index,
          value,
        ] of res.body.data.searchEngineGetCollections.entries()) {
          expect(collectionSeeder.collectionResponse[index]).toEqual(
            expect.objectContaining(
  ...
  test('/GraphQL searchEngineCreateCollection', () => {
    return request(app.getHttpServer())
      ...
      .expect(200)
      .then((res) => {
        expect(res.body.data.searchEngineCreateCollection).toHaveProperty(
          'id',
          '5b19d6ac-4081-573b-96b3-56964d5326a8',
        );
      });
  ...
  test('/GraphQL searchEngineFindCollection', () => {
    return request(app.getHttpServer())
      ...
      .expect(200)
      .then((res) => {
        expect(res.body.data.searchEngineFindCollection.id).toStrictEqual(
          '5b19d6ac-4081-573b-96b3-56964d5326a8',
        );
      });
  });
  ...
  test('/GraphQL searchEngineFindCollectionById', () => {
    return request(app.getHttpServer())
      ...
      .expect(200)
      .then((res) => {
        expect(res.body.data.searchEngineFindCollectionById.id).toStrictEqual(
          '5b19d6ac-4081-573b-96b3-56964d5326a8',
        );
      });
  });
  ...
  test('/GraphQL searchEngineUpdateCollectionById', () => {
    return request(app.getHttpServer())
      ...
      .expect(200)
      .then((res) => {
        expect(res.body.data.searchEngineUpdateCollectionById.id).toStrictEqual(
          '5b19d6ac-4081-573b-96b3-56964d5326a8',
        );
      });
  });
  ...
  test('/GraphQL searchEngineUpdateCollections', () => {
    return request(app.getHttpServer())
      ...
      .expect(200)
      .then((res) => {
        expect(res.body.data.searchEngineUpdateCollections[0].id).toStrictEqual(
          '5b19d6ac-4081-573b-96b3-56964d5326a8',
        );
      });
  });
  ...
  test('/GraphQL searchEngineDeleteCollectionById', () => {
    return request(app.getHttpServer())
      ...
      .expect(200)
      .then((res) => {
        expect(res.body.data.searchEngineDeleteCollectionById.id).toStrictEqual(
          '5b19d6ac-4081-573b-96b3-56964d5326a8',
        );
      });
  });
