...
├── @api/[package]/
│   ├── [module]/
│   │   ├── controllers/        # REST Controllers, entry point of the REST API
│   │   ├── dto/                # DTOs used by controllers and documentation generated in OpenAPI format through decorators
│   │   ├── graphql/            # Definition of types, inputs, queries, and mutations for the GraphQL API
│   │   ├── handlers/           # Service where both the REST API and GraphQL converge, containing the logic to be applied to the case covered by the API
│   │   ├── resolvers/          # Graphql Resolvers, entry point of the GraphQL API
│   │   ├── seeder/             # Service to populate the generated table with mock data for e2e testing
│   │   └── index.ts            # Exporting and grouping controllers, handlers, resolvers, and additional services
│   ├── [module].module.ts      # Declaration of controllers, handlers, resolvers, and additional services for NestJs Framework
│   └── [module].seeder.ts      # Service that defines the package name and permissions, if required, when the application starts up
│
├── @app/[package]/
│   ├── [module]/
│   │   ├── application/
...
│   └── public-api.ts
│
├── @aurora/                            # Folder containing base and reusable files for the Aurora structure
│   ├── decorators/                     # Decorator container folder; THIS FOLDER AND CONTENTS MUST NOT BE MODIFIED
│   │   ├── auth.decorator.ts           # Combines the Permissions decorator with UseGuards, used in RestFULL and GraphQL APIs
│   │   ├── gql-headers.decorator.ts    # Get headers at an API GraphQL entry point
│   │   ├── gql-request.decorator.ts    # Get request at an API GraphQL entry point
│   │   ├── index.ts                    # file to export decorators barrels
│   │   └── public-api.ts               # Barrels for decorators folder
│   │
│   ├── modules/                        # Modules container folder; THIS FOLDER AND CONTENTS MUST NOT BE MODIFIED
│   │   ├── cqrs/                       #
│   │   ├── graphql/                    #
│   │   ├── lang/                       #
│   │   ├── mailer/                     #
...
│   │   ├── sentry/                     #
│   │   ├── server-static/              #
│   │   ├── index.ts                    # file to export modules barrels
│   │   └── public-api.ts               # Barrels for modules folder
│   │
│   ├── services/                       # Services container folder; THIS FOLDER AND CONTENTS MUST NOT BE MODIFIED
│   │   ├── bootstrap.service.ts        #
│   │   ├── index.ts                    # file to export services barrels
│   │   ├── logger.service.ts           #
│   │   └── public-api.ts               #
│   │
│   ├── core.module.ts
...
├── app.module.ts
├── app.queues.ts
├── app.service.ts              # example service with a hello world
├── index.ts                    # file for sharing classes from the application, normally empty
├── main.ts                     # entry point of the nestjs application
└── repl.ts                     # file to start nestjs in REPL mode
```
