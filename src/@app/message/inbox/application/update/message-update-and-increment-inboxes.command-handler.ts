        ...
        await this.updateInboxesService.main(
            {
                ...
                title: new MessageInboxTitle(command.payload.title, { undefinable: true }),
                description: new MessageInboxDescription(command.payload.description, { undefinable: true }),
