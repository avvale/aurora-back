...
import { NotificationUpsertInboxCommand } from '@app/notification/inbox';
...
@CommandHandler(NotificationUpsertInboxCommand)
export class NotificationUpsertInboxCommandHandler implements ICommandHandler<NotificationUpsertInboxCommand>
{
    constructor(
        private readonly upsertInboxService: NotificationUpsertInboxService,
    ) {}

    async execute(command: NotificationUpsertInboxCommand): Promise<void>
    {
