...
describe('NotificationCreateOutboxService', () =>

{
    let service: NotificationCreateOutboxService;
    ...
    beforeAll(async () =>
    {
        ...
        service = module.get(NotificationCreateOutboxService);
    });

    describe('main', () =>
    {
        test('NotificationCreateOutboxService should be defined', () =>
        {
