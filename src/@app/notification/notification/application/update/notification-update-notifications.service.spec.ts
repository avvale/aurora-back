...
describe('NotificationUpdateNotificationsService', () =>
{
    let service: NotificationUpdateNotificationsService;
    ...
    beforeAll(async () =>
    {
        ...
        service = module.get(NotificationUpdateNotificationsService);
    });

    describe('main', () =>
    {
        test('UpdateNotificationsService should be defined', () =>
        {
