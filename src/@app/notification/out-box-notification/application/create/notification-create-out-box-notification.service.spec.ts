...
describe('NotificationCreateOutBoxNotificationService', () =>

{
    let service: NotificationCreateOutBoxNotificationService;
    ...
    beforeAll(async () =>
    {
        ...
        service = module.get(NotificationCreateOutBoxNotificationService);
    });

    describe('main', () =>
    {
        test('NotificationCreateOutBoxNotificationService should be defined', () =>
        {
            expect(service).toBeDefined();
        });

        test('should create a outBoxNotification and emit event', async () =>
        {
            expect(
                await service.main(
                    {
