...
describe('NotificationUpdateOutBoxNotificationsService', () =>
{
    let service: NotificationUpdateOutBoxNotificationsService;
    ...
    beforeAll(async () =>
    {
        ...
        service = module.get(NotificationUpdateOutBoxNotificationsService);
    });

    describe('main', () =>
    {
        test('UpdateOutBoxNotificationsService should be defined', () =>
        {
