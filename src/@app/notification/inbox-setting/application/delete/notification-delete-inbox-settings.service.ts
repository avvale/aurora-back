import { NotificationAddInboxSettingsContextEvent, NotificationIInboxSettingRepository } from '@app/notification/inbox-setting';
import { CQMetadata, QueryStatement } from '@aurorajs.dev/core';
import { Injectable } from '@nestjs/common';
import { EventPublisher } from '@nestjs/cqrs';

@Injectable()
export class NotificationDeleteInboxSettingsService
{
    constructor(
