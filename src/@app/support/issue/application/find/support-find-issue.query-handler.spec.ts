import { SupportFindIssueQuery, SupportIIssueRepository, SupportIssueMapper, SupportMockIssueRepository } from '@app/support/issue';
...
describe('SupportFindIssueQueryHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        queryHandler = module.get<SupportFindIssueQueryHandler>(SupportFindIssueQueryHandler);
