import { SupportFindIssueQuery, SupportIssueMapper, SupportIssueResponse } from '@app/support/issue';
...
export class SupportFindIssueQueryHandler implements IQueryHandler<SupportFindIssueQuery>
{
