import { SupportGetIssuesQuery, SupportIIssueRepository, SupportIssueMapper, SupportMockIssueRepository } from '@app/support/issue';
...
describe('GetIssuesQueryHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        queryHandler = module.get<SupportGetIssuesQueryHandler>(SupportGetIssuesQueryHandler);
