...
import { SupportCreateIssueCommand, supportMockIssueData } from '@app/support/issue';
...
describe('SupportCreateIssueCommandHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        commandHandler = module.get<SupportCreateIssueCommandHandler>(SupportCreateIssueCommandHandler);
    });
