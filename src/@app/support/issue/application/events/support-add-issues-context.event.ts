import { SupportCreatedIssueEvent, SupportCreatedIssuesEvent, SupportDeletedIssueEvent, SupportIssue, SupportUpdatedIssueEvent } from '@app/support/issue';
    ...
    created(): void
    {
        this.apply(
            new SupportCreatedIssuesEvent({
                payload: this.aggregateRoots.map(issue =>
