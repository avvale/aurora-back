...
export class SupportPaginateIssuesQueryHandler implements IQueryHandler<SupportPaginateIssuesQuery>
{
    constructor(
        private readonly paginateIssuesService: SupportPaginateIssuesService,
    ) {}

    async execute(query: SupportPaginateIssuesQuery): Promise<PaginationResponse>
    {
