import {
  ...
  SearchEngineRawSQLCollectionsQuery,
...
export class SearchEngineRawSQLCollectionsQueryHandler
  implements IQueryHandler<SearchEngineRawSQLCollectionsQuery>
{
  ...
  async execute(
    query: SearchEngineRawSQLCollectionsQuery,
  ): Promise<SearchEngineCollectionResponse[]> {
    return this.mapper.mapAggregatesToResponses(
      await this.rawSQLCollectionsService.main(query.rawSQL, query.cQMetadata),
    );
  }
}
