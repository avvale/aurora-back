...
export class SearchEngineRawSQLFieldsQueryHandler
  implements IQueryHandler<SearchEngineRawSQLFieldsQuery>
{
  ...
  async execute(
    query: SearchEngineRawSQLFieldsQuery,
  ): Promise<SearchEngineFieldResponse[]> {
    return this.mapper.mapAggregatesToResponses(
      await this.rawSQLFieldsService.main(query.rawSQL, query.cQMetadata),
    );
  }
}
