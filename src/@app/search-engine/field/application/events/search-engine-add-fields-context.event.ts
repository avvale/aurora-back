import {
  SearchEngineCreatedFieldEvent,
  SearchEngineCreatedFieldsEvent,
  SearchEngineDeletedFieldEvent,
  SearchEngineDeletedFieldsEvent,
  SearchEngineField,
  SearchEngineUpdatedFieldEvent,
  SearchEngineUpdatedFieldsEvent,
} from '@app/search-engine/field';
import { AggregateRoot } from '@nestjs/cqrs';

export class SearchEngineAddFieldsContextEvent extends AggregateRoot {
  constructor(public readonly aggregateRoots: SearchEngineField[] = []) {
    super();
  }
