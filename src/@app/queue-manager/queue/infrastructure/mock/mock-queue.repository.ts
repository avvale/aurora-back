    ...
    private createSourceMockData(): void
    {
        ...
        for (const itemCollection of <any[]>queues)
        {
            ...
            this.collectionSource.push(QueueManagerQueue.register(
                ...
                new QueueWaitingJobs(itemCollection.waitingJobs),
                new QueueActiveJobs(itemCollection.activeJobs),
                new QueueCompletedJobs(itemCollection.completedJobs),
                new QueueFailedJobs(itemCollection.failedJobs),
                new QueueDelayedJobs(itemCollection.delayedJobs),
                new QueuePausedJobs(itemCollection.pausedJobs),
