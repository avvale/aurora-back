        ...
        for (const queue of _.orderBy(queues, ['id']))
        {
            this.collectionSource.push(
                QueueManagerQueue.register(
                    ...
                    new QueueWaitingJobs(queue.waitingJobs),
                    new QueueActiveJobs(queue.activeJobs),
                    new QueueCompletedJobs(queue.completedJobs),
                    new QueueFailedJobs(queue.failedJobs),
                    new QueueDelayedJobs(queue.delayedJobs),
                    new QueuePausedJobs(queue.pausedJobs),
