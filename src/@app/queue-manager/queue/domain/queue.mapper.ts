...
export class QueueMapper implements IMapper
{
    ...
    private makeAggregate(queue: LiteralObject, cQMetadata?: CQMetadata): QueueManagerQueue
    {
        return QueueManagerQueue.register(
            ...
            new QueueWaitingJobs(queue.waitingJobs, { undefinable: true }),
            new QueueActiveJobs(queue.activeJobs, { undefinable: true }),
            new QueueCompletedJobs(queue.completedJobs, { undefinable: true }),
            new QueueFailedJobs(queue.failedJobs, { undefinable: true }),
            new QueueDelayedJobs(queue.delayedJobs, { undefinable: true }),
            new QueuePausedJobs(queue.pausedJobs, { undefinable: true }),
