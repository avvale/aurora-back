            ...
            command.payload
                .map(queue =>
                {
                    return {
                        ...
                        waitingJobs: new QueueWaitingJobs(queue.waitingJobs),
                        activeJobs: new QueueActiveJobs(queue.activeJobs),
                        completedJobs: new QueueCompletedJobs(queue.completedJobs),
                        failedJobs: new QueueFailedJobs(queue.failedJobs),
                        delayedJobs: new QueueDelayedJobs(queue.delayedJobs),
                        pausedJobs: new QueuePausedJobs(queue.pausedJobs),
                    };
                }),
            command.cQMetadata,
        );
