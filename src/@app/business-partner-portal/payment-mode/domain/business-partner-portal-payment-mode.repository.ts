...
import { BusinessPartnerPortalPaymentModeId } from './value-objects';

export abstract class BusinessPartnerPortalIPaymentModeRepository
  implements IRepository<BusinessPartnerPortalPaymentMode>
{
  ...
  abstract find(options?: {
    ...
    constraint?: QueryStatement;
    cQMetadata?: CQMetadata;
  }): Promise<BusinessPartnerPortalPaymentMode | null>;
  ...
  abstract create(
    ...
    options?: {
      ...
      dataFactory?: (
        aggregate: BusinessPartnerPortalPaymentMode,
      ) => LiteralObject;
