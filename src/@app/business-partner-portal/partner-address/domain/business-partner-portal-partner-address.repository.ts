...
import { BusinessPartnerPortalPartnerAddressId } from './value-objects';

export abstract class BusinessPartnerPortalIPartnerAddressRepository
  implements IRepository<BusinessPartnerPortalPartnerAddress>
{
  ...
  abstract find(options?: {
    ...
    constraint?: QueryStatement;
    cQMetadata?: CQMetadata;
  }): Promise<BusinessPartnerPortalPartnerAddress | null>;
  ...
  abstract create(
    ...
    options?: {
      ...
      dataFactory?: (
        aggregate: BusinessPartnerPortalPartnerAddress,
      ) => LiteralObject;
