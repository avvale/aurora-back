...
describe('BusinessPartnerPortalUpdatePartnerAddressByIdService', () => {
  let service: BusinessPartnerPortalUpdatePartnerAddressByIdService;
  ...
  beforeAll(async () => {
    ...
    service = module.get(BusinessPartnerPortalUpdatePartnerAddressByIdService);
  });

  describe('main', () => {
    test('BusinessPartnerPortalUpdatePartnerAddressByIdService should be defined', () => {
      expect(service).toBeDefined();
    });

    test('should update a partnerAddress and emit event', async () => {
      expect(
        await service.main(
          {
