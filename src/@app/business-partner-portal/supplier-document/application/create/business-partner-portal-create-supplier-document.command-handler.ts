 ...
 */
import { BusinessPartnerPortalCreateSupplierDocumentCommand } from '@app/business-partner-portal/supplier-document';
...
@CommandHandler(BusinessPartnerPortalCreateSupplierDocumentCommand)
export class BusinessPartnerPortalCreateSupplierDocumentCommandHandler
  implements ICommandHandler<BusinessPartnerPortalCreateSupplierDocumentCommand>
{
  constructor(
    private readonly createSupplierDocumentService: BusinessPartnerPortalCreateSupplierDocumentService,
  ) {}

  async execute(
    command: BusinessPartnerPortalCreateSupplierDocumentCommand,
  ): Promise<void> {
    // call to use case and implements ValueObjects
    await this.createSupplierDocumentService.main(
      {
