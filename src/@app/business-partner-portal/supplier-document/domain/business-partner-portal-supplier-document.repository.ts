 ...
 */
import { BusinessPartnerPortalSupplierDocument } from '@app/business-partner-portal/supplier-document';
import {
  CQMetadata,
  IRepository,
  LiteralObject,
...
import { BusinessPartnerPortalSupplierDocumentId } from './value-objects';

export abstract class BusinessPartnerPortalISupplierDocumentRepository
  implements IRepository<BusinessPartnerPortalSupplierDocument>
{
  ...
  abstract find(options?: {
    ...
    constraint?: QueryStatement;
    cQMetadata?: CQMetadata;
  }): Promise<BusinessPartnerPortalSupplierDocument | null>;
  ...
  abstract create(
    ...
    options?: {
      ...
      dataFactory?: (
        aggregate: BusinessPartnerPortalSupplierDocument,
      ) => LiteralObject;
