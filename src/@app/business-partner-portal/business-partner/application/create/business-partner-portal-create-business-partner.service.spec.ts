...
describe('BusinessPartnerPortalCreateBusinessPartnerService', () => {
  let service: BusinessPartnerPortalCreateBusinessPartnerService;
  ...
  beforeAll(async () => {
    ...
    service = module.get(BusinessPartnerPortalCreateBusinessPartnerService);
  });

  describe('main', () => {
    test('BusinessPartnerPortalCreateBusinessPartnerService should be defined', () => {
      expect(service).toBeDefined();
    });

    test('should create a businessPartner and emit event', async () => {
      expect(
        await service.main({
