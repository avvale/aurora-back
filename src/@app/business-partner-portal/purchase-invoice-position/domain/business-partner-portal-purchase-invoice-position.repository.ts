...
import { BusinessPartnerPortalPurchaseInvoicePositionId } from './value-objects';

export abstract class BusinessPartnerPortalIPurchaseInvoicePositionRepository
  implements IRepository<BusinessPartnerPortalPurchaseInvoicePosition>
{
  ...
  abstract find(options?: {
    ...
    constraint?: QueryStatement;
    cQMetadata?: CQMetadata;
  }): Promise<BusinessPartnerPortalPurchaseInvoicePosition | null>;
  ...
  abstract create(
    ...
    options?: {
      ...
      dataFactory?: (
        aggregate: BusinessPartnerPortalPurchaseInvoicePosition,
      ) => LiteralObject;
