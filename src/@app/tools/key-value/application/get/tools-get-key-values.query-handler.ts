import { ToolsGetKeyValuesQuery, ToolsKeyValue, ToolsKeyValueMapper, ToolsKeyValueResponse } from '@app/tools/key-value';
...
export class ToolsGetKeyValuesQueryHandler implements IQueryHandler<ToolsGetKeyValuesQuery>
{
    ...
    async execute(query: ToolsGetKeyValuesQuery): Promise<ToolsKeyValueResponse[] | LiteralObject[]>
    {
