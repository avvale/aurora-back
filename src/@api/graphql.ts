...
export enum BusinessPartnerPortalPaymentModeType {
...
export enum BusinessPartnerPortalPurchaseInvoiceHeaderStatus {
    DRAFT = "DRAFT",
    RECEIVED = "RECEIVED",
    APPROVED = "APPROVED",
    PAID = "PAID",
...
export enum BusinessPartnerPortalSalesInvoiceHeaderStatus {
    DRAFT = "DRAFT",
    SENT = "SENT",
    PAID = "PAID",
    PARTIALLY_PAID = "PARTIALLY_PAID",
...
export enum BusinessPartnerPortalSupplierDocumentDocumentType {
    INVOICE = "INVOICE",
...
export enum BusinessPartnerPortalSupplierDocumentStatus {
...
export interface BusinessPartnerPortalCreateBusinessPartnerInput {
    id: string;
    ...
    email?: Nullable<GraphQLString>;
    website?: Nullable<GraphQLString>;
    phone?: Nullable<GraphQLString>;
    phoneCountryPrefix?: Nullable<GraphQLString>;
    phoneSanitized?: Nullable<GraphQLString>;
    isActive: GraphQLBoolean;
    meta?: Nullable<JSON>;
}

export interface BusinessPartnerPortalUpdateBusinessPartnerByIdInput {
    id: string;
    externalId?: Nullable<GraphQLString>;
    code?: Nullable<GraphQLString>;
...
export interface BusinessPartnerPortalUpdateBusinessPartnersInput {
    id?: Nullable<string>;
    externalId?: Nullable<GraphQLString>;
    code?: Nullable<GraphQLString>;
    type?: Nullable<Nullable<BusinessPartnerPortalBusinessPartnerType>[]>;
...
export interface BusinessPartnerPortalCreatePartnerAddressInput {
    id: string;
    businessPartnerId: string;
    type: BusinessPartnerPortalPartnerAddressType;
    label?: Nullable<GraphQLString>;
    addressLine1: GraphQLString;
    addressLine2?: Nullable<GraphQLString>;
    city: GraphQLString;
    postalCode?: Nullable<GraphQLString>;
    countryId: string;
    administrativeAreaLevel1Id?: Nullable<string>;
    administrativeAreaLevel2Id?: Nullable<string>;
    administrativeAreaLevel3Id?: Nullable<string>;
    latitude?: Nullable<GraphQLFloat>;
    longitude?: Nullable<GraphQLFloat>;
    isPrimary: GraphQLBoolean;
    isActive: GraphQLBoolean;
    notes?: Nullable<GraphQLString>;
}

export interface BusinessPartnerPortalUpdatePartnerAddressByIdInput {
    id: string;
    businessPartnerId?: Nullable<string>;
    type?: Nullable<BusinessPartnerPortalPartnerAddressType>;
    label?: Nullable<GraphQLString>;
    addressLine1?: Nullable<GraphQLString>;
    addressLine2?: Nullable<GraphQLString>;
    city?: Nullable<GraphQLString>;
    postalCode?: Nullable<GraphQLString>;
    ...
    latitude?: Nullable<GraphQLFloat>;
    longitude?: Nullable<GraphQLFloat>;
    isPrimary?: Nullable<GraphQLBoolean>;
    isActive?: Nullable<GraphQLBoolean>;
    notes?: Nullable<GraphQLString>;
}

export interface BusinessPartnerPortalUpdatePartnerAddressesInput {
    id?: Nullable<string>;
    businessPartnerId?: Nullable<string>;
    type?: Nullable<BusinessPartnerPortalPartnerAddressType>;
    label?: Nullable<GraphQLString>;
...
export interface BusinessPartnerPortalCreatePartnerContactInput {
    id: string;
    businessPartnerId: string;
    firstName: GraphQLString;
    lastName: GraphQLString;
    position?: Nullable<GraphQLString>;
    department?: Nullable<GraphQLString>;
    email: GraphQLString;
    phone?: Nullable<GraphQLString>;
    phoneCountryPrefix?: Nullable<GraphQLString>;
    phoneSanitized?: Nullable<GraphQLString>;
    mobile?: Nullable<GraphQLString>;
    mobileCountryPrefix?: Nullable<GraphQLString>;
    mobileSanitized?: Nullable<GraphQLString>;
...
export interface BusinessPartnerPortalUpdatePartnerContactByIdInput {
    id: string;
    businessPartnerId?: Nullable<string>;
    firstName?: Nullable<GraphQLString>;
    ...
    mobileCountryPrefix?: Nullable<GraphQLString>;
    mobileSanitized?: Nullable<GraphQLString>;
    isPrincipal?: Nullable<GraphQLBoolean>;
    isActive?: Nullable<GraphQLBoolean>;
...
export interface BusinessPartnerPortalUpdatePartnerContactsInput {
    id?: Nullable<string>;
    businessPartnerId?: Nullable<string>;
    firstName?: Nullable<GraphQLString>;
    lastName?: Nullable<GraphQLString>;
...
export interface BusinessPartnerPortalCreatePaymentCollectionModeInput {
    id: string;
    businessPartnerId: string;
    paymentModeId: string;
    label?: Nullable<GraphQLString>;
    accountNumber?: Nullable<GraphQLString>;
    accountHolderName?: Nullable<GraphQLString>;
    bankName?: Nullable<GraphQLString>;
    routingNumber?: Nullable<GraphQLString>;
    iban?: Nullable<GraphQLString>;
    swiftCode?: Nullable<GraphQLString>;
    currencyCode?: Nullable<GraphQLString>;
    expirationDate?: Nullable<GraphQLISODateTime>;
    isPrimary: GraphQLBoolean;
    isActive: GraphQLBoolean;
    notes?: Nullable<GraphQLString>;
    lastUsedAt?: Nullable<GraphQLTimestamp>;
}

export interface BusinessPartnerPortalUpdatePaymentCollectionModeByIdInput {
    id: string;
    businessPartnerId?: Nullable<string>;
    paymentModeId?: Nullable<string>;
    label?: Nullable<GraphQLString>;
    accountNumber?: Nullable<GraphQLString>;
    accountHolderName?: Nullable<GraphQLString>;
    bankName?: Nullable<GraphQLString>;
...
export interface BusinessPartnerPortalUpdatePaymentCollectionModesInput {
    id?: Nullable<string>;
    businessPartnerId?: Nullable<string>;
    paymentModeId?: Nullable<string>;
    label?: Nullable<GraphQLString>;
...
export interface BusinessPartnerPortalCreatePaymentModeInput {
    id: string;
    externalId?: Nullable<GraphQLString>;
    code?: Nullable<GraphQLString>;
    name: GraphQLString;
    ...
    isAccountNumberRequired: GraphQLBoolean;
    isRoutingInfoRequired: GraphQLBoolean;
    isRecurringSupported: GraphQLBoolean;
    sort?: Nullable<GraphQLInt>;
    isActive: GraphQLBoolean;
    meta?: Nullable<JSON>;
}

export interface BusinessPartnerPortalUpdatePaymentModeByIdInput {
    id: string;
    externalId?: Nullable<GraphQLString>;
    code?: Nullable<GraphQLString>;
    name?: Nullable<GraphQLString>;
    description?: Nullable<GraphQLString>;
    type?: Nullable<BusinessPartnerPortalPaymentModeType>;
    isAccountNumberRequired?: Nullable<GraphQLBoolean>;
    isRoutingInfoRequired?: Nullable<GraphQLBoolean>;
    isRecurringSupported?: Nullable<GraphQLBoolean>;
    sort?: Nullable<GraphQLInt>;
    isActive?: Nullable<GraphQLBoolean>;
    meta?: Nullable<JSON>;
}

export interface BusinessPartnerPortalUpdatePaymentModesInput {
    id?: Nullable<string>;
    externalId?: Nullable<GraphQLString>;
    code?: Nullable<GraphQLString>;
    name?: Nullable<GraphQLString>;
...
export interface BusinessPartnerPortalCreatePurchaseInvoiceHeaderInput {
    id: string;
    invoiceNumber: GraphQLString;
    supplierInvoiceNumber?: Nullable<GraphQLString>;
    externalId?: Nullable<GraphQLString>;
    externalSystemCode?: Nullable<GraphQLString>;
    businessPartnerId: string;
    invoiceDate: GraphQLISODateTime;
    receivedDate?: Nullable<GraphQLISODateTime>;
    dueDate?: Nullable<GraphQLISODateTime>;
    status: BusinessPartnerPortalPurchaseInvoiceHeaderStatus;
    subtotal: GraphQLFloat;
    taxAmount: GraphQLFloat;
    discountAmount: GraphQLFloat;
    totalAmount: GraphQLFloat;
    paidAmount: GraphQLFloat;
    currencyCode: GraphQLString;
    paymentTermDays?: Nullable<GraphQLInt>;
    notes?: Nullable<GraphQLString>;
    approvalNotes?: Nullable<GraphQLString>;
}

export interface BusinessPartnerPortalUpdatePurchaseInvoiceHeaderByIdInput {
    id: string;
    invoiceNumber?: Nullable<GraphQLString>;
    supplierInvoiceNumber?: Nullable<GraphQLString>;
    externalId?: Nullable<GraphQLString>;
    externalSystemCode?: Nullable<GraphQLString>;
    businessPartnerId?: Nullable<string>;
    invoiceDate?: Nullable<GraphQLISODateTime>;
    receivedDate?: Nullable<GraphQLISODateTime>;
    dueDate?: Nullable<GraphQLISODateTime>;
    status?: Nullable<BusinessPartnerPortalPurchaseInvoiceHeaderStatus>;
    subtotal?: Nullable<GraphQLFloat>;
    taxAmount?: Nullable<GraphQLFloat>;
    discountAmount?: Nullable<GraphQLFloat>;
    totalAmount?: Nullable<GraphQLFloat>;
    paidAmount?: Nullable<GraphQLFloat>;
    currencyCode?: Nullable<GraphQLString>;
    paymentTermDays?: Nullable<GraphQLInt>;
    notes?: Nullable<GraphQLString>;
    approvalNotes?: Nullable<GraphQLString>;
...
export interface BusinessPartnerPortalUpdatePurchaseInvoiceHeadersInput {
    id?: Nullable<string>;
    invoiceNumber?: Nullable<GraphQLString>;
    supplierInvoiceNumber?: Nullable<GraphQLString>;
    externalId?: Nullable<GraphQLString>;
...
export interface BusinessPartnerPortalCreatePurchaseInvoicePositionInput {
    id: string;
    purchaseInvoiceHeaderId: string;
    positionNumber: GraphQLInt;
    description: GraphQLString;
    productCode?: Nullable<GraphQLString>;
    quantity: GraphQLFloat;
    unitPrice: GraphQLFloat;
    discountPercent: GraphQLFloat;
    discountAmount: GraphQLFloat;
    taxPercent: GraphQLFloat;
    taxAmount: GraphQLFloat;
    subtotal: GraphQLFloat;
    positionTotal: GraphQLFloat;
    expenseCategory?: Nullable<GraphQLString>;
    notes?: Nullable<GraphQLString>;
}

export interface BusinessPartnerPortalUpdatePurchaseInvoicePositionByIdInput {
    id: string;
    purchaseInvoiceHeaderId?: Nullable<string>;
    positionNumber?: Nullable<GraphQLInt>;
    description?: Nullable<GraphQLString>;
    productCode?: Nullable<GraphQLString>;
    quantity?: Nullable<GraphQLFloat>;
    unitPrice?: Nullable<GraphQLFloat>;
    discountPercent?: Nullable<GraphQLFloat>;
    discountAmount?: Nullable<GraphQLFloat>;
    taxPercent?: Nullable<GraphQLFloat>;
    taxAmount?: Nullable<GraphQLFloat>;
    subtotal?: Nullable<GraphQLFloat>;
    positionTotal?: Nullable<GraphQLFloat>;
    expenseCategory?: Nullable<GraphQLString>;
    notes?: Nullable<GraphQLString>;
}

export interface BusinessPartnerPortalUpdatePurchaseInvoicePositionsInput {
    id?: Nullable<string>;
    purchaseInvoiceHeaderId?: Nullable<string>;
    positionNumber?: Nullable<GraphQLInt>;
    description?: Nullable<GraphQLString>;
...
export interface BusinessPartnerPortalCreateSalesInvoiceHeaderInput {
    id: string;
    invoiceNumber: GraphQLString;
    externalId?: Nullable<GraphQLString>;
    externalSystemCode?: Nullable<GraphQLString>;
    ...
    paymentTermDays?: Nullable<GraphQLInt>;
    notes?: Nullable<GraphQLString>;
    customerNotes?: Nullable<GraphQLString>;
}

export interface BusinessPartnerPortalUpdateSalesInvoiceHeaderByIdInput {
    id: string;
    invoiceNumber?: Nullable<GraphQLString>;
    externalId?: Nullable<GraphQLString>;
    externalSystemCode?: Nullable<GraphQLString>;
    ...
    invoiceDate?: Nullable<GraphQLISODateTime>;
    dueDate?: Nullable<GraphQLISODateTime>;
    status?: Nullable<BusinessPartnerPortalSalesInvoiceHeaderStatus>;
    subtotal?: Nullable<GraphQLFloat>;
    taxAmount?: Nullable<GraphQLFloat>;
    discountAmount?: Nullable<GraphQLFloat>;
    totalAmount?: Nullable<GraphQLFloat>;
...
export interface BusinessPartnerPortalUpdateSalesInvoiceHeadersInput {
    id?: Nullable<string>;
    invoiceNumber?: Nullable<GraphQLString>;
    externalId?: Nullable<GraphQLString>;
    externalSystemCode?: Nullable<GraphQLString>;
...
export interface BusinessPartnerPortalCreateSalesInvoicePositionInput {
    id: string;
...
export interface BusinessPartnerPortalUpdateSalesInvoicePositionByIdInput {
    id: string;
    salesInvoiceHeaderId?: Nullable<string>;
    positionNumber?: Nullable<GraphQLInt>;
    description?: Nullable<GraphQLString>;
    productCode?: Nullable<GraphQLString>;
    quantity?: Nullable<GraphQLFloat>;
...
export interface BusinessPartnerPortalUpdateSalesInvoicePositionsInput {
    id?: Nullable<string>;
    salesInvoiceHeaderId?: Nullable<string>;
    positionNumber?: Nullable<GraphQLInt>;
    description?: Nullable<GraphQLString>;
...
export interface BusinessPartnerPortalCreateSupplierDocumentInput {
    id: string;
    businessPartnerId: string;
    documentNumber?: Nullable<GraphQLString>;
    documentType?: Nullable<BusinessPartnerPortalSupplierDocumentDocumentType>;
    status: BusinessPartnerPortalSupplierDocumentStatus;
    file?: Nullable<JSON>;
    fileHash?: Nullable<GraphQLString>;
    supplierInvoiceNumber?: Nullable<GraphQLString>;
    supplierInvoiceDate?: Nullable<GraphQLISODateTime>;
    supplierInvoiceAmount?: Nullable<GraphQLFloat>;
    currencyCode?: Nullable<GraphQLString>;
    externalDocumentId?: Nullable<GraphQLString>;
    externalCompanyCode?: Nullable<GraphQLString>;
    externalProcessingStatus?: Nullable<GraphQLString>;
    purchaseInvoiceHeaderId?: Nullable<string>;
    ocrConfidenceScore?: Nullable<GraphQLFloat>;
    ocrData?: Nullable<JSON>;
    sentForProcessingAt?: Nullable<GraphQLTimestamp>;
    processedAt?: Nullable<GraphQLTimestamp>;
    linkedAt?: Nullable<GraphQLTimestamp>;
    errorCode?: Nullable<GraphQLString>;
    errorMessage?: Nullable<GraphQLString>;
    retryCount: GraphQLInt;
    lastRetryAt?: Nullable<GraphQLTimestamp>;
    notes?: Nullable<GraphQLString>;
    supplierNotes?: Nullable<GraphQLString>;
    isArchived: GraphQLBoolean;
}

export interface BusinessPartnerPortalUpdateSupplierDocumentByIdInput {
    id: string;
    businessPartnerId?: Nullable<string>;
    documentNumber?: Nullable<GraphQLString>;
    documentType?: Nullable<BusinessPartnerPortalSupplierDocumentDocumentType>;
    status?: Nullable<BusinessPartnerPortalSupplierDocumentStatus>;
    file?: Nullable<JSON>;
    fileHash?: Nullable<GraphQLString>;
    supplierInvoiceNumber?: Nullable<GraphQLString>;
    supplierInvoiceDate?: Nullable<GraphQLISODateTime>;
    ...
    errorCode?: Nullable<GraphQLString>;
    errorMessage?: Nullable<GraphQLString>;
    retryCount?: Nullable<GraphQLInt>;
    lastRetryAt?: Nullable<GraphQLTimestamp>;
    notes?: Nullable<GraphQLString>;
    supplierNotes?: Nullable<GraphQLString>;
    isArchived?: Nullable<GraphQLBoolean>;
}

export interface BusinessPartnerPortalUpdateSupplierDocumentsInput {
    id?: Nullable<string>;
    businessPartnerId?: Nullable<string>;
    documentNumber?: Nullable<GraphQLString>;
    documentType?: Nullable<BusinessPartnerPortalSupplierDocumentDocumentType>;
...
export interface IQuery {
    ...
    businessPartnerPortalFindBusinessPartner(query?: Nullable<QueryStatement>, constraint?: Nullable<QueryStatement>): Nullable<BusinessPartnerPortalBusinessPartner> | Promise<Nullable<BusinessPartnerPortalBusinessPartner>>;
    businessPartnerPortalFindBusinessPartnerById(id?: Nullable<string>, constraint?: Nullable<QueryStatement>): Nullable<BusinessPartnerPortalBusinessPartner> | Promise<Nullable<BusinessPartnerPortalBusinessPartner>>;
    businessPartnerPortalGetBusinessPartners(query?: Nullable<QueryStatement>, constraint?: Nullable<QueryStatement>): Nullable<BusinessPartnerPortalBusinessPartner>[] | Promise<Nullable<BusinessPartnerPortalBusinessPartner>[]>;
    businessPartnerPortalPaginateBusinessPartners(query?: Nullable<QueryStatement>, constraint?: Nullable<QueryStatement>): Pagination | Promise<Pagination>;
    businessPartnerPortalFindPartnerAddress(query?: Nullable<QueryStatement>, constraint?: Nullable<QueryStatement>): Nullable<BusinessPartnerPortalPartnerAddress> | Promise<Nullable<BusinessPartnerPortalPartnerAddress>>;
    businessPartnerPortalFindPartnerAddressById(id?: Nullable<string>, constraint?: Nullable<QueryStatement>): Nullable<BusinessPartnerPortalPartnerAddress> | Promise<Nullable<BusinessPartnerPortalPartnerAddress>>;
    businessPartnerPortalGetPartnerAddresses(query?: Nullable<QueryStatement>, constraint?: Nullable<QueryStatement>): Nullable<BusinessPartnerPortalPartnerAddress>[] | Promise<Nullable<BusinessPartnerPortalPartnerAddress>[]>;
    businessPartnerPortalPaginatePartnerAddresses(query?: Nullable<QueryStatement>, constraint?: Nullable<QueryStatement>): Pagination | Promise<Pagination>;
    businessPartnerPortalFindPartnerContact(query?: Nullable<QueryStatement>, constraint?: Nullable<QueryStatement>): Nullable<BusinessPartnerPortalPartnerContact> | Promise<Nullable<BusinessPartnerPortalPartnerContact>>;
    businessPartnerPortalFindPartnerContactById(id?: Nullable<string>, constraint?: Nullable<QueryStatement>): Nullable<BusinessPartnerPortalPartnerContact> | Promise<Nullable<BusinessPartnerPortalPartnerContact>>;
    businessPartnerPortalGetPartnerContacts(query?: Nullable<QueryStatement>, constraint?: Nullable<QueryStatement>): Nullable<BusinessPartnerPortalPartnerContact>[] | Promise<Nullable<BusinessPartnerPortalPartnerContact>[]>;
    businessPartnerPortalPaginatePartnerContacts(query?: Nullable<QueryStatement>, constraint?: Nullable<QueryStatement>): Pagination | Promise<Pagination>;
    businessPartnerPortalFindPaymentCollectionMode(query?: Nullable<QueryStatement>, constraint?: Nullable<QueryStatement>): Nullable<BusinessPartnerPortalPaymentCollectionMode> | Promise<Nullable<BusinessPartnerPortalPaymentCollectionMode>>;
    businessPartnerPortalFindPaymentCollectionModeById(id?: Nullable<string>, constraint?: Nullable<QueryStatement>): Nullable<BusinessPartnerPortalPaymentCollectionMode> | Promise<Nullable<BusinessPartnerPortalPaymentCollectionMode>>;
    businessPartnerPortalGetPaymentCollectionModes(query?: Nullable<QueryStatement>, constraint?: Nullable<QueryStatement>): Nullable<BusinessPartnerPortalPaymentCollectionMode>[] | Promise<Nullable<BusinessPartnerPortalPaymentCollectionMode>[]>;
    businessPartnerPortalPaginatePaymentCollectionModes(query?: Nullable<QueryStatement>, constraint?: Nullable<QueryStatement>): Pagination | Promise<Pagination>;
    businessPartnerPortalFindPaymentMode(query?: Nullable<QueryStatement>, constraint?: Nullable<QueryStatement>): Nullable<BusinessPartnerPortalPaymentMode> | Promise<Nullable<BusinessPartnerPortalPaymentMode>>;
    businessPartnerPortalFindPaymentModeById(id?: Nullable<string>, constraint?: Nullable<QueryStatement>): Nullable<BusinessPartnerPortalPaymentMode> | Promise<Nullable<BusinessPartnerPortalPaymentMode>>;
    businessPartnerPortalGetPaymentModes(query?: Nullable<QueryStatement>, constraint?: Nullable<QueryStatement>): Nullable<BusinessPartnerPortalPaymentMode>[] | Promise<Nullable<BusinessPartnerPortalPaymentMode>[]>;
    businessPartnerPortalPaginatePaymentModes(query?: Nullable<QueryStatement>, constraint?: Nullable<QueryStatement>): Pagination | Promise<Pagination>;
    businessPartnerPortalFindPurchaseInvoiceHeader(query?: Nullable<QueryStatement>, constraint?: Nullable<QueryStatement>): Nullable<BusinessPartnerPortalPurchaseInvoiceHeader> | Promise<Nullable<BusinessPartnerPortalPurchaseInvoiceHeader>>;
    businessPartnerPortalFindPurchaseInvoiceHeaderById(id?: Nullable<string>, constraint?: Nullable<QueryStatement>): Nullable<BusinessPartnerPortalPurchaseInvoiceHeader> | Promise<Nullable<BusinessPartnerPortalPurchaseInvoiceHeader>>;
    businessPartnerPortalGetPurchaseInvoiceHeaders(query?: Nullable<QueryStatement>, constraint?: Nullable<QueryStatement>): Nullable<BusinessPartnerPortalPurchaseInvoiceHeader>[] | Promise<Nullable<BusinessPartnerPortalPurchaseInvoiceHeader>[]>;
    businessPartnerPortalPaginatePurchaseInvoiceHeaders(query?: Nullable<QueryStatement>, constraint?: Nullable<QueryStatement>): Pagination | Promise<Pagination>;
    businessPartnerPortalFindPurchaseInvoicePosition(query?: Nullable<QueryStatement>, constraint?: Nullable<QueryStatement>): Nullable<BusinessPartnerPortalPurchaseInvoicePosition> | Promise<Nullable<BusinessPartnerPortalPurchaseInvoicePosition>>;
    businessPartnerPortalFindPurchaseInvoicePositionById(id?: Nullable<string>, constraint?: Nullable<QueryStatement>): Nullable<BusinessPartnerPortalPurchaseInvoicePosition> | Promise<Nullable<BusinessPartnerPortalPurchaseInvoicePosition>>;
    businessPartnerPortalGetPurchaseInvoicePositions(query?: Nullable<QueryStatement>, constraint?: Nullable<QueryStatement>): Nullable<BusinessPartnerPortalPurchaseInvoicePosition>[] | Promise<Nullable<BusinessPartnerPortalPurchaseInvoicePosition>[]>;
    businessPartnerPortalPaginatePurchaseInvoicePositions(query?: Nullable<QueryStatement>, constraint?: Nullable<QueryStatement>): Pagination | Promise<Pagination>;
    businessPartnerPortalFindSalesInvoiceHeader(query?: Nullable<QueryStatement>, constraint?: Nullable<QueryStatement>): Nullable<BusinessPartnerPortalSalesInvoiceHeader> | Promise<Nullable<BusinessPartnerPortalSalesInvoiceHeader>>;
    businessPartnerPortalFindSalesInvoiceHeaderById(id?: Nullable<string>, constraint?: Nullable<QueryStatement>): Nullable<BusinessPartnerPortalSalesInvoiceHeader> | Promise<Nullable<BusinessPartnerPortalSalesInvoiceHeader>>;
    businessPartnerPortalGetSalesInvoiceHeaders(query?: Nullable<QueryStatement>, constraint?: Nullable<QueryStatement>): Nullable<BusinessPartnerPortalSalesInvoiceHeader>[] | Promise<Nullable<BusinessPartnerPortalSalesInvoiceHeader>[]>;
    businessPartnerPortalPaginateSalesInvoiceHeaders(query?: Nullable<QueryStatement>, constraint?: Nullable<QueryStatement>): Pagination | Promise<Pagination>;
    businessPartnerPortalFindSalesInvoicePosition(query?: Nullable<QueryStatement>, constraint?: Nullable<QueryStatement>): Nullable<BusinessPartnerPortalSalesInvoicePosition> | Promise<Nullable<BusinessPartnerPortalSalesInvoicePosition>>;
    businessPartnerPortalFindSalesInvoicePositionById(id?: Nullable<string>, constraint?: Nullable<QueryStatement>): Nullable<BusinessPartnerPortalSalesInvoicePosition> | Promise<Nullable<BusinessPartnerPortalSalesInvoicePosition>>;
    businessPartnerPortalGetSalesInvoicePositions(query?: Nullable<QueryStatement>, constraint?: Nullable<QueryStatement>): Nullable<BusinessPartnerPortalSalesInvoicePosition>[] | Promise<Nullable<BusinessPartnerPortalSalesInvoicePosition>[]>;
    businessPartnerPortalPaginateSalesInvoicePositions(query?: Nullable<QueryStatement>, constraint?: Nullable<QueryStatement>): Pagination | Promise<Pagination>;
    businessPartnerPortalFindSupplierDocument(query?: Nullable<QueryStatement>, constraint?: Nullable<QueryStatement>): Nullable<BusinessPartnerPortalSupplierDocument> | Promise<Nullable<BusinessPartnerPortalSupplierDocument>>;
    businessPartnerPortalFindSupplierDocumentById(id?: Nullable<string>, constraint?: Nullable<QueryStatement>): Nullable<BusinessPartnerPortalSupplierDocument> | Promise<Nullable<BusinessPartnerPortalSupplierDocument>>;
    businessPartnerPortalGetSupplierDocuments(query?: Nullable<QueryStatement>, constraint?: Nullable<QueryStatement>): Nullable<BusinessPartnerPortalSupplierDocument>[] | Promise<Nullable<BusinessPartnerPortalSupplierDocument>[]>;
    businessPartnerPortalPaginateSupplierDocuments(query?: Nullable<QueryStatement>, constraint?: Nullable<QueryStatement>): Pagination | Promise<Pagination>;
...
export interface IMutation {
    ...
    businessPartnerPortalCreateBusinessPartner(payload: BusinessPartnerPortalCreateBusinessPartnerInput): Nullable<BusinessPartnerPortalBusinessPartner> | Promise<Nullable<BusinessPartnerPortalBusinessPartner>>;
    businessPartnerPortalUpdateBusinessPartnerById(payload: BusinessPartnerPortalUpdateBusinessPartnerByIdInput, constraint?: Nullable<QueryStatement>): Nullable<BusinessPartnerPortalBusinessPartner> | Promise<Nullable<BusinessPartnerPortalBusinessPartner>>;
    businessPartnerPortalDeleteBusinessPartnerById(id: string, constraint?: Nullable<QueryStatement>): Nullable<BusinessPartnerPortalBusinessPartner> | Promise<Nullable<BusinessPartnerPortalBusinessPartner>>;
    businessPartnerPortalCreatePartnerAddress(payload: BusinessPartnerPortalCreatePartnerAddressInput): Nullable<BusinessPartnerPortalPartnerAddress> | Promise<Nullable<BusinessPartnerPortalPartnerAddress>>;
    businessPartnerPortalUpdatePartnerAddressById(payload: BusinessPartnerPortalUpdatePartnerAddressByIdInput, constraint?: Nullable<QueryStatement>): Nullable<BusinessPartnerPortalPartnerAddress> | Promise<Nullable<BusinessPartnerPortalPartnerAddress>>;
    businessPartnerPortalDeletePartnerAddressById(id: string, constraint?: Nullable<QueryStatement>): Nullable<BusinessPartnerPortalPartnerAddress> | Promise<Nullable<BusinessPartnerPortalPartnerAddress>>;
    businessPartnerPortalCreatePartnerContact(payload: BusinessPartnerPortalCreatePartnerContactInput): Nullable<BusinessPartnerPortalPartnerContact> | Promise<Nullable<BusinessPartnerPortalPartnerContact>>;
    businessPartnerPortalUpdatePartnerContactById(payload: BusinessPartnerPortalUpdatePartnerContactByIdInput, constraint?: Nullable<QueryStatement>): Nullable<BusinessPartnerPortalPartnerContact> | Promise<Nullable<BusinessPartnerPortalPartnerContact>>;
    businessPartnerPortalDeletePartnerContactById(id: string, constraint?: Nullable<QueryStatement>): Nullable<BusinessPartnerPortalPartnerContact> | Promise<Nullable<BusinessPartnerPortalPartnerContact>>;
    businessPartnerPortalCreatePaymentCollectionMode(payload: BusinessPartnerPortalCreatePaymentCollectionModeInput): Nullable<BusinessPartnerPortalPaymentCollectionMode> | Promise<Nullable<BusinessPartnerPortalPaymentCollectionMode>>;
    businessPartnerPortalUpdatePaymentCollectionModeById(payload: BusinessPartnerPortalUpdatePaymentCollectionModeByIdInput, constraint?: Nullable<QueryStatement>): Nullable<BusinessPartnerPortalPaymentCollectionMode> | Promise<Nullable<BusinessPartnerPortalPaymentCollectionMode>>;
    businessPartnerPortalDeletePaymentCollectionModeById(id: string, constraint?: Nullable<QueryStatement>): Nullable<BusinessPartnerPortalPaymentCollectionMode> | Promise<Nullable<BusinessPartnerPortalPaymentCollectionMode>>;
    businessPartnerPortalCreatePaymentMode(payload: BusinessPartnerPortalCreatePaymentModeInput): Nullable<BusinessPartnerPortalPaymentMode> | Promise<Nullable<BusinessPartnerPortalPaymentMode>>;
    businessPartnerPortalUpdatePaymentModeById(payload: BusinessPartnerPortalUpdatePaymentModeByIdInput, constraint?: Nullable<QueryStatement>): Nullable<BusinessPartnerPortalPaymentMode> | Promise<Nullable<BusinessPartnerPortalPaymentMode>>;
    businessPartnerPortalDeletePaymentModeById(id: string, constraint?: Nullable<QueryStatement>): Nullable<BusinessPartnerPortalPaymentMode> | Promise<Nullable<BusinessPartnerPortalPaymentMode>>;
    businessPartnerPortalCreatePurchaseInvoiceHeader(payload: BusinessPartnerPortalCreatePurchaseInvoiceHeaderInput): Nullable<BusinessPartnerPortalPurchaseInvoiceHeader> | Promise<Nullable<BusinessPartnerPortalPurchaseInvoiceHeader>>;
    businessPartnerPortalUpdatePurchaseInvoiceHeaderById(payload: BusinessPartnerPortalUpdatePurchaseInvoiceHeaderByIdInput, constraint?: Nullable<QueryStatement>): Nullable<BusinessPartnerPortalPurchaseInvoiceHeader> | Promise<Nullable<BusinessPartnerPortalPurchaseInvoiceHeader>>;
    businessPartnerPortalDeletePurchaseInvoiceHeaderById(id: string, constraint?: Nullable<QueryStatement>): Nullable<BusinessPartnerPortalPurchaseInvoiceHeader> | Promise<Nullable<BusinessPartnerPortalPurchaseInvoiceHeader>>;
    businessPartnerPortalCreatePurchaseInvoicePosition(payload: BusinessPartnerPortalCreatePurchaseInvoicePositionInput): Nullable<BusinessPartnerPortalPurchaseInvoicePosition> | Promise<Nullable<BusinessPartnerPortalPurchaseInvoicePosition>>;
    businessPartnerPortalUpdatePurchaseInvoicePositionById(payload: BusinessPartnerPortalUpdatePurchaseInvoicePositionByIdInput, constraint?: Nullable<QueryStatement>): Nullable<BusinessPartnerPortalPurchaseInvoicePosition> | Promise<Nullable<BusinessPartnerPortalPurchaseInvoicePosition>>;
    businessPartnerPortalDeletePurchaseInvoicePositionById(id: string, constraint?: Nullable<QueryStatement>): Nullable<BusinessPartnerPortalPurchaseInvoicePosition> | Promise<Nullable<BusinessPartnerPortalPurchaseInvoicePosition>>;
    businessPartnerPortalCreateSalesInvoiceHeader(payload: BusinessPartnerPortalCreateSalesInvoiceHeaderInput): Nullable<BusinessPartnerPortalSalesInvoiceHeader> | Promise<Nullable<BusinessPartnerPortalSalesInvoiceHeader>>;
    businessPartnerPortalUpdateSalesInvoiceHeaderById(payload: BusinessPartnerPortalUpdateSalesInvoiceHeaderByIdInput, constraint?: Nullable<QueryStatement>): Nullable<BusinessPartnerPortalSalesInvoiceHeader> | Promise<Nullable<BusinessPartnerPortalSalesInvoiceHeader>>;
    businessPartnerPortalDeleteSalesInvoiceHeaderById(id: string, constraint?: Nullable<QueryStatement>): Nullable<BusinessPartnerPortalSalesInvoiceHeader> | Promise<Nullable<BusinessPartnerPortalSalesInvoiceHeader>>;
    businessPartnerPortalCreateSalesInvoicePosition(payload: BusinessPartnerPortalCreateSalesInvoicePositionInput): Nullable<BusinessPartnerPortalSalesInvoicePosition> | Promise<Nullable<BusinessPartnerPortalSalesInvoicePosition>>;
    businessPartnerPortalUpdateSalesInvoicePositionById(payload: BusinessPartnerPortalUpdateSalesInvoicePositionByIdInput, constraint?: Nullable<QueryStatement>): Nullable<BusinessPartnerPortalSalesInvoicePosition> | Promise<Nullable<BusinessPartnerPortalSalesInvoicePosition>>;
    businessPartnerPortalDeleteSalesInvoicePositionById(id: string, constraint?: Nullable<QueryStatement>): Nullable<BusinessPartnerPortalSalesInvoicePosition> | Promise<Nullable<BusinessPartnerPortalSalesInvoicePosition>>;
    businessPartnerPortalCreateSupplierDocument(payload: BusinessPartnerPortalCreateSupplierDocumentInput): Nullable<BusinessPartnerPortalSupplierDocument> | Promise<Nullable<BusinessPartnerPortalSupplierDocument>>;
    businessPartnerPortalUpdateSupplierDocumentById(payload: BusinessPartnerPortalUpdateSupplierDocumentByIdInput, constraint?: Nullable<QueryStatement>): Nullable<BusinessPartnerPortalSupplierDocument> | Promise<Nullable<BusinessPartnerPortalSupplierDocument>>;
    businessPartnerPortalDeleteSupplierDocumentById(id: string, constraint?: Nullable<QueryStatement>): Nullable<BusinessPartnerPortalSupplierDocument> | Promise<Nullable<BusinessPartnerPortalSupplierDocument>>;
...
export interface BusinessPartnerPortalBusinessPartner {
    ...
    phoneSanitized?: Nullable<GraphQLString>;
    isActive: GraphQLBoolean;
    contacts?: Nullable<Nullable<BusinessPartnerPortalPartnerContact>[]>;
    addresses?: Nullable<Nullable<BusinessPartnerPortalPartnerAddress>[]>;
    paymentCollectionModes?: Nullable<Nullable<BusinessPartnerPortalPaymentCollectionMode>[]>;
    meta?: Nullable<JSON>;
    createdAt?: Nullable<GraphQLTimestamp>;
    updatedAt?: Nullable<GraphQLTimestamp>;
    deletedAt?: Nullable<GraphQLTimestamp>;
...
export interface BusinessPartnerPortalPartnerAddress {
    ...
    rowId: GraphQLInt;
    businessPartnerId: string;
    businessPartner?: Nullable<BusinessPartnerPortalBusinessPartner>;
    type: BusinessPartnerPortalPartnerAddressType;
    label?: Nullable<GraphQLString>;
    addressLine1: GraphQLString;
    addressLine2?: Nullable<GraphQLString>;
    ...
    administrativeAreaLevel3Id?: Nullable<string>;
    administrativeAreaLevel3?: Nullable<CommonAdministrativeAreaLevel3>;
    latitude?: Nullable<GraphQLFloat>;
    longitude?: Nullable<GraphQLFloat>;
    isPrimary: GraphQLBoolean;
    isActive: GraphQLBoolean;
...
export interface BusinessPartnerPortalPaymentCollectionMode {
    ...
    businessPartner?: Nullable<BusinessPartnerPortalBusinessPartner>;
    paymentModeId: string;
    paymentMode?: Nullable<BusinessPartnerPortalPaymentMode>;
    label?: Nullable<GraphQLString>;
    accountNumber?: Nullable<GraphQLString>;
    accountHolderName?: Nullable<GraphQLString>;
    bankName?: Nullable<GraphQLString>;
...
export interface BusinessPartnerPortalPurchaseInvoiceHeader {
    ...
    notes?: Nullable<GraphQLString>;
    approvalNotes?: Nullable<GraphQLString>;
    positions?: Nullable<Nullable<BusinessPartnerPortalPurchaseInvoicePosition>[]>;
    createdAt?: Nullable<GraphQLTimestamp>;
    updatedAt?: Nullable<GraphQLTimestamp>;
    deletedAt?: Nullable<GraphQLTimestamp>;
}
...
export interface BusinessPartnerPortalPurchaseInvoicePosition {
    ...
    rowId: GraphQLInt;
    purchaseInvoiceHeaderId: string;
    purchaseInvoiceHeader?: Nullable<BusinessPartnerPortalPurchaseInvoiceHeader>;
    positionNumber: GraphQLInt;
    description: GraphQLString;
    productCode?: Nullable<GraphQLString>;
    quantity: GraphQLFloat;
...
export interface BusinessPartnerPortalSalesInvoiceHeader {
    ...
    notes?: Nullable<GraphQLString>;
    customerNotes?: Nullable<GraphQLString>;
    positions?: Nullable<Nullable<BusinessPartnerPortalSalesInvoicePosition>[]>;
    createdAt?: Nullable<GraphQLTimestamp>;
    updatedAt?: Nullable<GraphQLTimestamp>;
    deletedAt?: Nullable<GraphQLTimestamp>;
}
...
export interface BusinessPartnerPortalSalesInvoicePosition {
    ...
    rowId: GraphQLInt;
    salesInvoiceHeaderId: string;
    salesInvoiceHeader?: Nullable<BusinessPartnerPortalSalesInvoiceHeader>;
    positionNumber: GraphQLInt;
    description: GraphQLString;
    productCode?: Nullable<GraphQLString>;
    quantity: GraphQLFloat;
