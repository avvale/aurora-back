...
@Controller('common/attachment-families-resources/paginate')
@Auth('common.attachmentFamilyResource.get')
export class CommonPaginateAttachmentFamiliesResourcesController
{
    constructor(
    ...
    @Post()
    @HttpCode(200)
    @ApiOperation({ summary: 'Paginate attachment-families-resources' })
