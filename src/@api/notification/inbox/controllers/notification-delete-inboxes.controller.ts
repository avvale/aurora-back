...
import { NotificationDeleteInboxesHandler, NotificationInboxDto } from '@api/notification/inbox';
...
@Controller('notification/inboxes/delete')
@Auth('notification.inbox.delete')
export class NotificationDeleteInboxesController
{
    constructor(
    ...
    @ApiOkResponse({ description: 'The records has been deleted successfully.', type: [NotificationInboxDto]})
