...
import { NotificationDeleteInboxByIdHandler, NotificationInboxDto } from '@api/notification/inbox';
...
@Controller('notification/inbox/delete')
@Auth('notification.inbox.delete')
export class NotificationDeleteInboxByIdController
{
    constructor(
    ...
    @ApiOkResponse({ description: 'The record has been deleted successfully.', type: NotificationInboxDto })
    @TenantConstraint()
    async main(
