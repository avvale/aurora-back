...
describe('SearchEngineUpdateCollectionsController', () => {
  ...
  beforeAll(async () => {
    const module: TestingModule = await Test.createTestingModule({
      imports: [],
      controllers: [SearchEngineUpdateCollectionsController],
      providers: [
        {
    ...
    controller = module.get<SearchEngineUpdateCollectionsController>(
      SearchEngineUpdateCollectionsController,
    );
    handler = module.get<SearchEngineUpdateCollectionsHandler>(
      SearchEngineUpdateCollectionsHandler,
    );
  });
  ...
  describe('main', () => {
    ...
    test('should return a collections updated', async () => {
      ...
      expect(await controller.main(searchEngineMockCollectionData[0])).toBe(
