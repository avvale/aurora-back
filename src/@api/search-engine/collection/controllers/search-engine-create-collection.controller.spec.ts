...
describe('SearchEngineCreateCollectionController', () => {
  ...
  beforeAll(async () => {
    const module: TestingModule = await Test.createTestingModule({
      imports: [],
      controllers: [SearchEngineCreateCollectionController],
      providers: [
        {
    ...
    controller = module.get<SearchEngineCreateCollectionController>(
      SearchEngineCreateCollectionController,
    );
    handler = module.get<SearchEngineCreateCollectionHandler>(
      SearchEngineCreateCollectionHandler,
    );
  });
