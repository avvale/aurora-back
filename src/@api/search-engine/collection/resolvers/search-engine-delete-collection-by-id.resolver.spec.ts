...
describe('SearchEngineDeleteCollectionByIdResolver', () => {
  ...
  beforeAll(async () => {
    ...
    resolver = module.get<SearchEngineDeleteCollectionByIdResolver>(
      SearchEngineDeleteCollectionByIdResolver,
    );
    handler = module.get<SearchEngineDeleteCollectionByIdHandler>(
      SearchEngineDeleteCollectionByIdHandler,
    );
  });
  ...
  describe('main', () => {
    ...
    test('should return an collection deleted', async () => {
      ...
      expect(await resolver.main(searchEngineMockCollectionData[0].id)).toBe(
