...
describe('SearchEngineDeleteFieldByIdController', () => {
  ...
  beforeAll(async () => {
    const module: TestingModule = await Test.createTestingModule({
      imports: [],
      controllers: [SearchEngineDeleteFieldByIdController],
      providers: [
        {
    ...
    controller = module.get<SearchEngineDeleteFieldByIdController>(
      SearchEngineDeleteFieldByIdController,
    );
    handler = module.get<SearchEngineDeleteFieldByIdHandler>(
      SearchEngineDeleteFieldByIdHandler,
    );
  });
