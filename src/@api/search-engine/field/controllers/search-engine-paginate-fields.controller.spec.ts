...
describe('SearchEnginePaginateFieldsController', () => {
  ...
  beforeAll(async () => {
    const module: TestingModule = await Test.createTestingModule({
      imports: [],
      controllers: [SearchEnginePaginateFieldsController],
      providers: [
        {
    ...
    controller = module.get<SearchEnginePaginateFieldsController>(
      SearchEnginePaginateFieldsController,
    );
    handler = module.get<SearchEnginePaginateFieldsHandler>(
      SearchEnginePaginateFieldsHandler,
    );
  });
