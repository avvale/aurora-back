import { SupportPaginateIssuesController, SupportPaginateIssuesHandler } from '@api/support/issue';
...
describe('SupportPaginateIssuesController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<SupportPaginateIssuesController>(SupportPaginateIssuesController);
