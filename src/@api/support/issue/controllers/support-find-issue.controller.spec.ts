import { SupportFindIssueController, SupportFindIssueHandler } from '@api/support/issue';
...
describe('SupportFindIssueController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<SupportFindIssueController>(SupportFindIssueController);
