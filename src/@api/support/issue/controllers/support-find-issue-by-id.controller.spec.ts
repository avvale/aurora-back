import { SupportFindIssueByIdController, SupportFindIssueByIdHandler } from '@api/support/issue';
...
describe('SupportFindIssueByIdController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<SupportFindIssueByIdController>(SupportFindIssueByIdController);
