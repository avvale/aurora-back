import { SupportGetIssuesController, SupportGetIssuesHandler } from '@api/support/issue';
...
describe('SupportGetIssuesController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<SupportGetIssuesController>(SupportGetIssuesController);
    ...
    describe('main', () =>
    {
        ...
        {
            jest.spyOn(handler, 'main').mockImplementation(() => new Promise(resolve => resolve(supportMockIssueData)));
