...
import { SupportDeleteIssueByIdController, SupportDeleteIssueByIdHandler } from '@api/support/issue';
...
describe('SupportDeleteIssueByIdController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<SupportDeleteIssueByIdController>(SupportDeleteIssueByIdController);
    ...
    describe('main', () =>
    {
        ...
        test('should return an issue deleted', async () =>
        {
            ...
            expect(await controller.main(supportMockIssueData[0].id)).toBe(supportMockIssueData[0]);
        });
    });
});
