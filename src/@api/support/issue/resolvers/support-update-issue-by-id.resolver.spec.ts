...
import { SupportUpdateIssueByIdHandler, SupportUpdateIssueByIdResolver } from '@api/support/issue';
...
describe('SupportUpdateIssueByIdResolver', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        resolver = module.get<SupportUpdateIssueByIdResolver>(SupportUpdateIssueByIdResolver);
    ...
    describe('main', () =>
    {
        ...
        test('should return a issue by id updated', async () =>
        {
            ...
            expect(await resolver.main(<SupportUpdateIssueByIdInput>supportMockIssueData[0])).toBe(supportMockIssueData[0]);
        });
    });
});
