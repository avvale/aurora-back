...
import { SupportFindIssueByIdHandler, SupportFindIssueByIdResolver } from '@api/support/issue';
...
describe('SupportFindIssueByIdResolver', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        resolver = module.get<SupportFindIssueByIdResolver>(SupportFindIssueByIdResolver);
