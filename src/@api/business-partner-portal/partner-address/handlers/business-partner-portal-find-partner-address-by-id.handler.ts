...
import { BusinessPartnerPortalFindPartnerAddressByIdQuery } from '@app/business-partner-portal/partner-address';
import { IQueryBus, QueryStatement } from '@aurorajs.dev/core';
import { Injectable, NotFoundException } from '@nestjs/common';

@Injectable()
export class BusinessPartnerPortalFindPartnerAddressByIdHandler {
