...
export class BusinessPartnerPortalPartnerAddressDto {
  @ApiProperty({
    type: String,
    description:
  ...
  @ApiProperty({
    ...
    description:
      'CommonAdministrativeAreaLevel3 [input here api field description]',
  })
  administrativeAreaLevel3?: CommonAdministrativeAreaLevel3Dto;
