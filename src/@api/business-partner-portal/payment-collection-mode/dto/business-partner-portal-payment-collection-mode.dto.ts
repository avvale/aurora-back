...
import { BusinessPartnerPortalPaymentModeDto } from '@api/business-partner-portal/payment-mode';
import { ApiProperty } from '@nestjs/swagger';

export class BusinessPartnerPortalPaymentCollectionModeDto {
  @ApiProperty({
    type: String,
    description:
  ...
  @ApiProperty({
    ...
    description:
      'BusinessPartnerPortalPaymentMode [input here api field description]',
  })
  paymentMode?: BusinessPartnerPortalPaymentModeDto;
