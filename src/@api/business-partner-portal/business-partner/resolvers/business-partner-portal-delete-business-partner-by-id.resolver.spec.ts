...
describe('BusinessPartnerPortalDeleteBusinessPartnerByIdResolver', () => {
  let resolver: BusinessPartnerPortalDeleteBusinessPartnerByIdResolver;
  ...
  beforeAll(async () => {
    ...
    resolver =
      module.get<BusinessPartnerPortalDeleteBusinessPartnerByIdResolver>(
        BusinessPartnerPortalDeleteBusinessPartnerByIdResolver,
      );
  ...
  test('BusinessPartnerPortalDeleteBusinessPartnerByIdResolver should be defined', () => {
