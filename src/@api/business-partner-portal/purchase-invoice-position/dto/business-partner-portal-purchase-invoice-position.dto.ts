 ...
 */
import { BusinessPartnerPortalPurchaseInvoiceHeaderDto } from '@api/business-partner-portal/purchase-invoice-header';
import { ApiProperty } from '@nestjs/swagger';

export class BusinessPartnerPortalPurchaseInvoicePositionDto {
  @ApiProperty({
    type: String,
    description:
  ...
  @ApiProperty({
    ...
    description:
      'BusinessPartnerPortalPurchaseInvoiceHeader [input here api field description]',
  })
  purchaseInvoiceHeader?: BusinessPartnerPortalPurchaseInvoiceHeaderDto;
