...
@Controller('business-partner-portal/sales-invoice-headers/get')
@Auth('businessPartnerPortal.salesInvoiceHeader.get')
export class BusinessPartnerPortalGetSalesInvoiceHeadersController {
  constructor(
  ...
  @Post()
  @HttpCode(200)
  @ApiOperation({ summary: 'Get sales-invoice-headers according to query' })
  @ApiOkResponse({
