---
name: nestjs-expert
description: Expert in building scalable and efficient applications using the NestJS framework. Focused on CQRS design pattern, best practices, and performance optimization specific to NestJS.
model: sonnet
---
